$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b2169bea68921bc0f0bfa9a964494a6b'
            && MD5($('#invite_code').val()) !== 'b2169bea68921bc0f0bfa9a964494a6b') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbxTXBGy3fgEWk1hjd74jax4z0tFmWR8xQsWaScIXgkkp778yoFrrOgsev6gHcHQiHFDEw/exec', data)
                .done(function (data) {
                    console.log(data);
...
function initBBSRMap() {
    var la_fiesta = {lat: 37.774281, lng: -1.453797};
